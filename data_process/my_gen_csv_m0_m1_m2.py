...
# csv_all = Path(__file__).parent.parent.joinpath('datafiles', data_version, task_type + 'aaa.csv')
...
# csv_train = Path(__file__).parent.parent.joinpath('datafiles', data_version, task_type + '_train.csv')
# csv_valid = Path(__file__).parent.parent.joinpath('datafiles', data_version, task_type + '_valid.csv')
# csv_test = Path(__file__).parent.parent.joinpath('datafiles', data_version, task_type + '_test.csv')
...
write_images_labels_csv(files_train, labels_train, filename_csv=csv_train)
write_images_labels_csv(files_valid, labels_valid, filename_csv=csv_valid)
write_images_labels_csv(files_test, labels_test, filename_csv=csv_test)
