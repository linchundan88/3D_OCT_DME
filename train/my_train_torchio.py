...
ds_train = Dataset_CSV(csv_file=csv_train, image_shape=image_shape)
loader_train = DataLoader(ds_train, batch_size=batch_size_train,
                          sampler=sampler, num_workers=4)
ds_valid = Dataset_CSV(csv_file=csv_valid, image_shape=image_shape)
loader_valid = DataLoader(ds_valid, batch_size=batch_size_valid,
                          num_workers=4)
ds_test = Dataset_CSV(csv_file=csv_test, image_shape=image_shape)
loader_test = DataLoader(ds_test, batch_size=batch_size_valid,
                         num_workers=4)
#endregion

#region training
save_model_dir = f'/tmp2/2020_2_22/{data_version}'
train_times = 1
