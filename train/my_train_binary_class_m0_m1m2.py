...
parser.add_argument('--weight_decay', default=0)  #L2 regularization, 1e-4 is too big
parser.add_argument('--epochs_num', default=14)
...
parser.add_argument('--save_model_dir', default='/tmp2/2022_4_24/binary_classifier_m0_m1m2/')
...
imgaug_iaa = iaa.Sequential([
    # iaa.Fliplr(0.5),  #using torchio instead: tio.RandomFlip(axes=2, flip_probability=0.5),
...
#region define model
if args.pre_trained:
    path_trained_models = Path(__file__).resolve().parent.parent / 'pre_trained_models'
