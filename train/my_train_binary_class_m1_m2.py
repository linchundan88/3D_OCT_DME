...
parser.add_argument('--pos_weight', default=(1.,))  #cost sensitive learning, weighted binary cross entropy
...
parser.add_argument('--save_model_dir', default='/tmp2/2021_7_25/binary_classifier_m1_m2/')
