...
def get_model(model_name, num_class=2, model_file=None, **params):
    ...
    if model_name == 'cls_3d':
        from cls_3d.libs.neural_networks.model.cls_3d import Cls_3d
        model = Cls_3d(n_class=num_class, dropout_prob=drop_prob)

    # region medical net
    if model_name == 'medical_net_resnet34':
        from cls_3d.libs.neural_networks.model.MedicalNet.resnet import resnet34, Resnet3d_cls
    ...
    if model_name == 'medical_net_resnet50':
        from cls_3d.libs.neural_networks.model.MedicalNet.resnet import resnet50, Resnet3d_cls
    ...
    if model_name == 'medical_net_resnet101':
        from cls_3d.libs.neural_networks.model.MedicalNet.resnet import resnet101, Resnet3d_cls
    ...
    if model_name == 'ModelsGenesis':
        from cls_3d.libs.neural_networks.model.ModelsGenesis.unet3d import UNet3D, TargetNet
        base_model = UNet3D()
        model = TargetNet(base_model, n_class=num_class)

    # region 3D ResNet  [10, 18, 34, 50, 101, 152, 200]
    from cls_3d.libs.neural_networks.model.model_3d.resnet import generate_model
