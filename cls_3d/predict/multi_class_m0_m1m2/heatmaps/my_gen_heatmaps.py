...
dir_dest = '/disk1/3D_OCT_DME/results/2021_7_31/heatmaps_multi_class/heatmaps/test/'
...
from cls_3d.libs.dataset.my_dataset_torchio import get_tensor
            ...
            if heatmap_type in ['GuidedBackprop', 'IntegratedGradients', 'GuidedGradCam']:
                ...
                if heatmap_type == 'IntegratedGradients':
                    if not noise_tunnel:
                        ...
                        attribution = nt.attribute(tensor_x, nt_type='smoothgrad',
                                                   stdevs=0.05, nt_samples=4, target=class_predict)
