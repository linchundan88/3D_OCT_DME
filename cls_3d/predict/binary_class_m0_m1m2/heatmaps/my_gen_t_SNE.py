...
from cls_3d.libs.neural_networks.heatmaps.t_SNE.my_tsne_helper import compute_features_files, gen_tse_features, draw_tsne


#region load model and set some parameters
csv_file = os.path.join(os.path.abspath('../../../'), 'datafiles', 'v3', '3D_OCT_DME_M0_M1M2_test.csv')
dir_dest = '/disk1/3D_OCT_DME/results/2021_8_1/heatmaps_binary_class/t_SNE/'
