...
parser.add_argument('--data_version', default='v5')
...
parser.add_argument('--save_model_dir', default='/tmp2/2021_11_29/binary_classifier_m1_m2/')
...
from cls_3d.libs.neural_networks.helper.my_train_binary_class import train
...
if args.model_name == 'cls_3d':
    model_file = Path(__file__).resolve().parent.parent.joinpath('trained_models', 'binary_class_m0_m1m2', 'cls_3d.pth')
if args.model_name == 'medical_net_resnet50':
    model_file = Path(__file__).resolve().parent.parent.joinpath('trained_models', 'binary_class_m0_m1m2', 'medical_net_resnet50.pth')
